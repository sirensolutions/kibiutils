...
var _kibiutils = _interopRequireDefault(require("../kibiutils.js"));
...
describe('Json traversing', function () {
  describe('getValuesAtPath', function () {
    it('non existing path', function () {
      var values = _kibiutils.default.getValuesAtPath({
        aaa: 'bbb'
      }, ['not', 'in', 'there']);

      (0, _expect.default)(values).to.have.length(0);
    });
    it('non existing path in nested object', function () {
      ...
      var values = _kibiutils.default.getValuesAtPath(json, ['aaa', 'ccc']);
    ...
    it('get value at level one', function () {
      ...
      (0, _expect.default)(values).to.eql(['bbb']);
    });
    it('get nested value', function () {
      ...
      var values = _kibiutils.default.getValuesAtPath(json, ['aaa', 'bbb']);

      (0, _expect.default)(values).to.eql([123]);
    });
    it('value is an array', function () {
      ...
      var values = _kibiutils.default.getValuesAtPath(json, ['aaa']);

      (0, _expect.default)(values).to.eql([123, 456]);
    });
    ...
    it('multiple values with some that are arrays are reachable via path', function () {
      ...
      (0, _expect.default)(values).to.eql([123, 456, 789]);
    });
    it('nested array mix', function () {
      ...
      var values = _kibiutils.default.getValuesAtPath(json, ['aaa', 'bbb', 'ccc']);
    ...
    describe('nulls', function () {
      it('on level 1', function () {
        ...
        (0, _expect.default)(_kibiutils.default.getValuesAtPath(json, ['aaa'])).to.have.length(0);
        (0, _expect.default)(_kibiutils.default.getValuesAtPath(json, ['aaa', 'bbb'])).to.have.length(0);
      });
      it('on level 2', function () {
        ...
        (0, _expect.default)(_kibiutils.default.getValuesAtPath(json, ['aaa', 'bbb'])).to.have.length(0);
        (0, _expect.default)(_kibiutils.default.getValuesAtPath(json, ['aaa', 'bbb', 'ccc'])).to.have.length(0);
      });
      it('in array', function () {
        var json = {
          aaa: [123, null]
        };
        (0, _expect.default)(_kibiutils.default.getValuesAtPath(json, ['aaa'])).to.eql([123]);
      });
      it('nested in array', function () {
        ...
        (0, _expect.default)(_kibiutils.default.getValuesAtPath(json, ['aaa', 'bbb'])).to.eql([123]);
      });
    });
    describe('dotted field names', function () {
      ...
      it('nested', function () {
        ...
        (0, _expect.default)(_kibiutils.default.getValuesAtPath(json, ['aaa.bbb', 'ccc'])).to.eql([123]);
      });
    });
  });
  describe('goToElement', function () {
    it('object in array', function () {
      ...
      _kibiutils.default.goToElement(json, ['aaa', '0', 'bbb'], function (nested) {
        if (nested === 'ccc') {
          ccc++;
        } else if (nested === 'ddd') {
          ddd++;
      ...
      (0, _expect.default)(ccc).to.eql(1);
      (0, _expect.default)(ddd).to.eql(0);

      _kibiutils.default.goToElement(json, ['aaa', '1', 'bbb'], function (nested) {
        if (nested === 'ccc') {
          ccc++;
        } else if (nested === 'ddd') {
          ddd++;
      ...
      (0, _expect.default)(ccc).to.eql(1);
      (0, _expect.default)(ddd).to.eql(1);
    });
    it('object nested in array', function () {
      ...
      _kibiutils.default.goToElement(json, ['aaa', '0', 'ccc', 'eee'], function (nested) {
        (0, _expect.default)(nested).to.eql(42);
      });
    });
    it('nested object', function () {
      ...
      _kibiutils.default.goToElement(json, ['aaa', 'bbb', '0'], function (nested) {
        (0, _expect.default)(nested).to.eql({
          ccc: 'ccc'
        });
      });
    });
    it('nested arrays', function () {
      ...
      _kibiutils.default.goToElement(json, ['aaa', '1', '0', 'bbb'], function (nested) {
        if (nested === 'ccc') {
          ccc++;
        } else if (nested === 'ddd') {
          ddd++;
      ...
      _kibiutils.default.goToElement(json, ['aaa', '1', '1', 'bbb'], function (nested) {
        if (nested === 'ccc') {
          ccc++;
        } else if (nested === 'ddd') {
          ddd++;
...
describe('Error handling', function () {
  describe('with goToElement', function () {
    it('bad path 1', function () {
      ...
      (0, _expect.default)(_kibiutils.default.goToElement).withArgs(json, ['aaa', 'bbb']).to.throwException(/unexpected json type/i);
    });
    it('bad path 2', function () {
      var json = {
        aaa: 'bbb'
      };
      (0, _expect.default)(_kibiutils.default.goToElement).withArgs(json, ['ccc']).to.throwException(/no property=\[ccc\]/i);
    });
  });
});
describe('uuid generation', function () {
  it('get uuid4', function () {
    var uuid4 = _kibiutils.default.getUuid4();

    (0, _expect.default)(uuid4).to.match(/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[0-9a-f]{4}-[0-9a-f]{12}$/);
  });
});
describe('slugifyId()', function () {
  ...
  var _loop = function _loop(i) {
    ...
    it(msg, function () {
      var results = _kibiutils.default.slugifyId(fixture[0]);

      (0, _expect.default)(results).to.be(fixture[1]);
    });
  };
  ...
  it('should do nothing if the id is undefined', function () {
    (0, _expect.default)(_kibiutils.default.slugifyId(undefined)).to.be(undefined);
  });
});
describe('doesQueryDependOnEntity()', function () {
  ...
  it('should check queries for commented lines on activationQuery', function () {
    ...
    (0, _expect.default)(_kibiutils.default.doesQueryDependOnEntity(queries)).to.be(false);
  });
  it('should check queries for not commented lines on activationQuery', function () {
    for (var i = 0; i < dependentQueries.length; i++) {
      ...
      (0, _expect.default)(_kibiutils.default.doesQueryDependOnEntity([query])).to.be(true);
    }
  });
