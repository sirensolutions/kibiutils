  ...
  _createClass(Migration, [{
    ...
    value: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(index, type, query, options) {
        ...
        var returnEventEmmiter = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                objects = [];
                emitter = returnEventEmmiter === true ? new _events2.default.EventEmitter() : undefined;
                emmitedObjects = 0;
