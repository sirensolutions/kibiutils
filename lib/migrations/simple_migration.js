  ...
  _createClass(SimpleMigration, [{
    ...
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var migrationCount, _getSearchParams3, index, type, query, objects, bulkIndex, upgradeCount, i, savedObject, _upgradeObject2, _index, _type, _id, _source;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 15:
                ...
                _upgradeObject2 = this._upgradeObject(savedObject), _index = _upgradeObject2._index, _type = _upgradeObject2._type, _id = _upgradeObject2._id, _source = _upgradeObject2._source;
    ...
    key: 'checkOutdated',
    value: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(savedObject) {
        var currentVersion;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                currentVersion = savedObject._source[savedObject._source.type].version;
    ...
    value: function _getSearchParams() {
      ...
      if (this._savedObjectType) {
        ...
        params.type = this._type || _constants.DEFAULT_TYPE;
        params.query = {
          query: {
            match: {
