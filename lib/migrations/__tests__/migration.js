...
describe('migrations', function () {
  ...
  describe('Migration', function () {
    ...
    describe('countHits', function () {
      ...
      it('should build the correct query and return the result', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    ...
    Object.keys(ES_API).forEach(function (version) {
      var esApi = ES_API[version];
      describe('ES ' + version + ': scrollSearch', function () {
        ...
        it('should set default options if options have not been defined', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
          var migration;
        ...
        it('should set a default size if no size has been specified', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
          var migration;
        ...
        it('should use the specified size', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
          var migration;
        ...
        it('should use the scroll API to fetch hits', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
