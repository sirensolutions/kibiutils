  ...
  describe('MigrationRunner', function () {
    ...
    describe('getMigrations', function () {
      ...
      describe('should', function () {
            ...
            while (1) {
              switch (_context9.prev = _context9.next) {
                case 0:
                  ...
                  (0, _expect2.default)(firstCallResp).to.equal(secondCallResp);
        ...
        it('should use patched es client for migrations', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10() {
            ...
            while (1) {
              switch (_context10.prev = _context10.next) {
                case 0:
                  ...
                  (0, _expect2.default)(migrations.length).to.equal(3);
                  (0, _expect2.default)(server.plugins.elasticsearch.getCluster.callCount).to.equal(1);
                  (0, _expect2.default)(migrations[0]._client.bulk).to.equal(patchedBulk);
                  (0, _expect2.default)(migrations[1]._client.bulk).to.equal(patchedBulk);
                  (0, _expect2.default)(migrations[2]._client.bulk).to.equal(patchedBulk);
      ...
      describe('cleanup', function () {
        ...
        it('removes bulk patch from esClient', function () {
          ...
          (0, _expect2.default)(beforeCleanup).to.not.equal(afterCleanup);
        });
      });
    });
  });
