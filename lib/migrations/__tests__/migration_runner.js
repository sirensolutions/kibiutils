...
describe('migrations', function () {
  ...
  describe('MigrationRunner', function () {
    ...
    describe('count', function () {
      ...
      it('should execute migrations in the correct order', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
        var result, migrations, descriptions;
    ...
    describe('getMigrations', function () {
      ...
      describe('should', function () {
        ...
        it('cache migrations', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
          var runner;
